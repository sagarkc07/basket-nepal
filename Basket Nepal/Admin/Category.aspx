                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidatortxtName" runat="server" ErrorMessage="Category name is required." ControlToValidate="txtName"></asp:RequiredFieldValidator>--%>
